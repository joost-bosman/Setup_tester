...
### Export
- TXT and PDF exports include results + suggestions.
...
- Taal-detectie gebruikt IP voor regio; er wordt niets opgeslagen.

### Download-optimalisatie tips
...
2. Wybierz **Krotki** dla gotowosci, **Rozszerzony** dla maksymalnej wydajnosci.
...
### Prywatnosc
- Diagnostyka lokalna.
- Auto-jezyk korzysta z IP; nic nie jest zapisywane.

### Wskazowki pobierania
- Jasny changelog i screeny.
- Male, podpisane instalatory.
- Krotki przewodnik "pierwsze uruchomienie".
